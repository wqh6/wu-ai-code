package com.example.wuaicode.core.handler;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.example.wuaicode.ai.model.message.*;
import com.example.wuaicode.ai.tools.BaseTool;
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    String outputPath =AppConstant.CODE_OUTPUT_ROOT_DIR+"/vue_project_"+appId;
                    vueProjectBuilder.buildProjectAsync(outputPath);
                })
                .doOnError(error -> {
                    // 如果AI回复失败，也要记录错误消息
