package com.example.wuaicode.service.impl;
...
import com.example.wuaicode.core.AiCodeGeneratorFacade;
import com.example.wuaicode.core.builder.VueProjectBuilder;
import com.example.wuaicode.core.handler.StreamHandlerExecutor;
import com.example.wuaicode.exception.BusinessException;
import com.example.wuaicode.exception.ErrorCode;
import com.example.wuaicode.exception.ThrowUtils;
import com.example.wuaicode.mapper.AppMapper;
...
import com.example.wuaicode.model.vo.UserVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 5. 调用 AI 生成代码
        Flux<String> codeResult = aiCodeGeneratorFacade.generateAndSaverCode(message, codeGenTypeEnum, appId);
        return streamHandlerExecutor.doExecute(codeResult, chatHistoryService, appId, loginUser, codeGenTypeEnum);
    }
    @Override
    public String deployApp(Long appId, User loginUser) {
        ...
        if(enumByValue == CodeGenTypeEnum.VUE_PROJECT){
            ...
            File fileDir = new File(sourceDirPath, "dist");
            sourceDir = fileDir;
        }
        // 7. 复制文件到部署目录
        ...
        // 9. 返回可访问的 URL
        return String.format("%s/%s/", AppConstant.CODE_DEPLOY_HOST_LOCAL, deployKey);
    }
